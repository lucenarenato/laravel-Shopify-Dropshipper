            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.settings.update',$records->id) }}" method="POST" name="edit_category" enctype="multipart/form-data">
                            @csrf
...
{{--                            @method('PUT')--}}
                                ...
                                @if(count($records->CmsPagesContent)>0)
                                    ...
                                    <div class="row">
                                           @if( $field->field_type=="htmlcontent" && $field->field_slug!=="reviews_step_content")
                                            <div class="col-md-12">
                                        ...
                                        @elseif ($field->field_type=="file" && $field->field_slug!=="reviews_step_content")
                                            <div class="col-md-12">
                                                <div class="row">
                                        ...
                                        @else
                                            @if($field->field_slug!=="reviews_step_content")
                                        <div class="col-md-12">
                                                <div class="form-group">
                                                    <strong>{{ $field->field_label }}</strong>
                                                    <input type="{{ $field->field_type }}" name="{{ $field->field_slug }}" value="{{ $field->field_value }}" class="form-control" placeholder="" >
